...
conversion in place and names it on stderr. Remove it by naming it directly
(`eject runs/sources/report.md`), or give the KB attributable conversions with
`factlog ingest --scan --force`.
