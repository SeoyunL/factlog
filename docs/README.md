...
| [값 계층](reference/value-hierarchy.md) | `policy/value-hierarchy.md`, 하위유형 포섭, 적용 범위 계약, 순환과 경고 |
| [값 어휘 감사](reference/value-audit.md) | `tools/value_audit.py`, `--strict`, `policy/identity-relations.md` |
